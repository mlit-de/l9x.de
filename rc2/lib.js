...
(function (global, factory) {
    ...
    class Acceptor {
        ...
        open() {
            switch(this.method) {
                case "window": {
                    this.w = window.open("https://vi4/rc/S.html");
                    break;
                }
                case "frame": {
                    var ifr = document.createElement("iframe")
                    this.w = ifr
                    ifr.src = "https://vi4/rc/S.html"
                    ifr.height = "50%"
                    ifr.width = "100%"
